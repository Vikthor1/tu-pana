...
const BASE = 'http://127.0.0.1:3001/explore.html?concept=integrated';
const KEY = 'tupana-explore:writing-studio-ux-2026-08:integrated:v1';
...
await surfaces.goto('http://127.0.0.1:3001/explore.html?concept=notebook');
await surfaces.evaluate(() => localStorage.removeItem('tupana-explore:writing-studio-ux-2026-08:notebook:v1'));
await surfaces.reload();
check('Notebook/reference writing surface uses native spellcheck by default', await surfaces.locator('#notebookEditor').evaluate(el => el.spellcheck));
