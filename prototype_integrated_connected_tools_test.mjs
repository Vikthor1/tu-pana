// Integrated Desk Connected Writing Tools checks.
...
check('fresh English density remains materially close to the 185-word baseline', freshWords <= 190, `${freshWords} visible words`);
